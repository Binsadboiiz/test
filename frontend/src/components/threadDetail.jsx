                    ...
                    {posts.map((post) => (
                        <div className="comment-item" key={post._id}>
                            {post.author?.avatarUrl ? (
                                <div className="avatar-circle small-avatar">
                                    <img src={getAvatarUrl(post.author.avatarUrl)} alt={post.author.displayname || "avatar"} className="avatar-img" />
                                </div>
                            ) : (
                                <div className="avatar-circle small-avatar">
                                    <span className="avatar-initial">{post.author?.displayname ? post.author.displayname.charAt(0).toUpperCase() : "U"}</span>
                                </div>
                            )}
